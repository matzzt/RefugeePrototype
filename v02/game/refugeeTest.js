window.onload = function() {
	...
	Crafty.sprite(16, "game/img/sprite2.png", {
		grass1: [0,0],
		grass2: [1,0],
		grass3: [2,0],
		grass4: [3,0],
	...
	Crafty.scene("loading", function() {
		...
		Crafty.load(["game/img/sprite2.png"], function () {
	...
	Crafty.scene("main", function() {
		...
		player = Crafty.e("2D, Canvas, player, RightControls, Hero, Animate, Collision, Camera")
			.attr({x: 160, y: 180, z: 1})
			.centerOn()
			.rightControls(1);
	});
};