Crafty.c("DropFactory", {
	...
	getStoneBoulder1: function() { 
		var name = "Stone Boulder";
		var sprite = "stoneBoulder";
		var min = 2;
		var max = 4;
		var desc = "A stone Boulder. It's not very useful in this form maybe you should do something with it.";
		var prob = 1;
		return this.createDrop(name,sprite,min,max,desc,prob);
	},
	getStoneBoulder2: function() { 
		var name = "Stone Boulder";
		var sprite = "stoneBoulder";
		var min = 1;
		var max = 1;
