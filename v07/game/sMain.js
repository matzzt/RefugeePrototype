Crafty.scene("main", function () {		
		...
		var craftTable = Crafty.e("2D, DOM, RandomPosition, craftTable, CraftingPlace, solid")
							.randomPositionNear(globalMap, true, PLAYER.x, PLAYER.y, 10)
							.setCraftingName("Craft Table")
							.addRecipe(recipeFactory.getWoodenSwordRecipe())
							.addRecipe(recipeFactory.getWoodenAxeRecipe())
							.addRecipe(recipeFactory.getWoodenPickRecipe())
							.addRecipe(recipeFactory.getStoneSwordRecipe())
							.addRecipe(recipeFactory.getStoneAxeRecipe())
							.addRecipe(recipeFactory.getStonePickRecipe());
							
		var stoneTable = Crafty.e("2D, DOM, RandomPosition, stoneTable, CraftingPlace, solid")
							.randomPositionNear(globalMap, true, PLAYER.x, PLAYER.y, 15)
							.setCraftingName("Stone Crafting")
							.addRecipe(recipeFactory.getBlockRecipe());
							
		/*var tutorialGuy = Crafty.e("2D, DOM, RandomPosition, oldGuy, Keyboard, TutorialGuy, solid")
							.randomPositionNear(globalMap, true, PLAYER.x, PLAYER.y, 5);*/
	});